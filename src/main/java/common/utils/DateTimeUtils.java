...
public class DateTimeUtils {
    ...
    public static void main(String[] args) {
        String d1 = "2015-09-08";
        String d2 = "2015-09-09";
        System.out.println(difference(DateTimeField.DAY, parse(d1, YEAR_MONTH_DATE_FORMAT), parse(d2, YEAR_MONTH_DATE_FORMAT), false));
    }
}